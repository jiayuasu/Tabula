...
trait BasePrep {
  ...
  def prep(dataFrame: DataFrame, sampledAttribute: String, predicateDfLocation:String, rawInputPath:String): DataFrame

  def prep(dataFrame: DataFrame, sampledAttribute: String, predicateDfLocation:String): DataFrame
}
